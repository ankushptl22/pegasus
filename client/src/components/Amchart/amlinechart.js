                    ...
                    <AmCharts.React style={{ width: "100%", height: "300px" }} options={{
                        ...
                        "panels": [{
                            ...
                            "stockGraphs": [{
                                ...
                                "balloonText": "<div style='margin:2px; font-size:10px;'>Active Leads:<b>[[value]]</b></div>"
                                ...
                                "balloonText": "<div style='margin:2px; font-size:10px;'>Registaration:<b>[[value]]</b></div>"
                                ...
                                "balloonText": "<div style='margin:2px; font-size:10px;'>Data Extraction:<b>[[value]]</b></div>"
                                ...
                                "balloonText": "<div style='margin:2px; font-size:10px;'>CMS Reporting:<b>[[value]]</b></div>"
                                ...
                                "balloonText": "<div style='margin:2px; font-size:10px;'>Production:<b>[[value]]</b></div>"
